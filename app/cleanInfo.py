...
def currencySigntoCode(currencySign,currencyIndexDict):
    currencyCode = currencyIndexDict[currencySign].lower()
    return currencyCode

# Convert forenign's amount to EURO
def invoiceAMTConvert(result_Currency,result_InvoiceAMT,CurrencyRate):
    if result_Currency == 'eur':
        result_InvoiceAMT_conv = result_InvoiceAMT
    else:
        result_InvoiceAMT_conv = CurrencyRate[result_Currency]['inverseRate']*result_InvoiceAMT
    return result_InvoiceAMT_conv
